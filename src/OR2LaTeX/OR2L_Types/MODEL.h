...
namespace OR2L
{
    ...
    {
    public:
        MODEL(const REGEX_STRING &name, const std::initializer_list<INDEX> indexes, const std::initializer_list<VARIABLE> variables, const std::initializer_list<CONSTRAINT> constraints) : name_(name)
        {
