...
static std::map<ExceptionType, std::string_view> EXCEPTION_TEXT = {
    {ExceptionType::ERR_SYMBOLSTRING_INVALIDCHAR,
     "The specified string contains an invalid character."},
    {ExceptionType::ERR_INDEX_BOUNDS,
     "The specified lower bound is higher than the upper bound."},
    {ExceptionType::ERR_MODEL_NULLPTRSOLVER,
     "The underlying solver pointer is equal to 'nullptr'. Did you forget to "
